...
| P1.5.17 | todo | Build submission review queue in Studio | `/studio/submissions` page: list all pending submissions with product name, submitter, content preview, timestamp. Admin can approve, reject, or request more info. Approved submissions become source material for AI-enhanced guide generation. | P1.5.16 | P1.5.18 |
